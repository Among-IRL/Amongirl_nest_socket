  ...
  public resetGame(): GameModel {
    this.game = {
      ...
      rooms: [
        ...
        { name: 'Supprimer les absences', mac: '123', task: false },
        // { name: 'Réparer le robinet', mac: '', task: false },
        // { name: 'Fermer le distributeur de papier', mac: '', task: false },
        // { name: 'Réparer la machine à café', mac: '', task: false },
        // { name: 'Effacer le tableau', mac: '', task: false },
        // { name: 'Ranger les affaires IOT', mac: '', task: false },
        // { name: 'Réparer le ditributeur', mac: '', task: false },
      ],
      start: false,
    };
